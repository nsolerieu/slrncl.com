...
<main>
  ...
  <section class="hero" >
    <div class="container">
      <div class="row">
        <div class="col-100">
          <h1  class="text-color-primary">Hey, I'm Nicolas.</h1>
        </div>
      </div>
    </div>
  </section>
  ...
  <section>
    <div class="container">
      <div class="row full-row-border-top">
        <div class="col-100">
          <h2 class="small-margin-top">
            I’m a designer, cyclist, and odd dad living in San Luis Obispo, CA.
          </h2>

          <p class="large-margin-top text-color-secondary">
            I'm currently a web designer at <a href="https://github.com/nsolerieu">GitHub</a>. I'm used to working in fast-paced environments and collaborating with interdisciplinary teams. My specialty is web design but have been enjoying creating all sorts of visuals like icons, illustrations and prototypes. <br>
            <br>
          ...
          <p class="large-margin-top text-small text-color-secondary">This is the kind of stuff I make for a living:</p>

          <div class="video-container large-margin-top">
