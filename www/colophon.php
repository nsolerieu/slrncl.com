...
<main>
  ...
  <section class="padded-section">
    <div class="container">
      <div class="row">
        <div class="col-100">
          <h2 class="text-color-primary no-margin">Ethos</h2>
          ...
          <h2 class="text-color-primary large-margin-top">Tracking</h2>
          <p class="small-margin-top text-regular text-color-secondary">
          ...
          <h2 class="text-color-primary large-margin-top">Typography</h2>
          <p class="small-margin-top text-regular text-color-secondary">
          ...
          <h2 class="text-color-primary large-margin-top">PHP</h2>
          <p class="small-margin-top text-regular text-color-secondary">
          ...
          <h2 class="text-color-primary large-margin-top">Javascript</h2>
          <p class="small-margin-top text-regular text-color-secondary">
