    ...
    <div class="row full-row-border-top">
      <div class="col-100">
        ...
        <div class="footer-bottom">
          ...
          <a href="<?php echo BASE_URL; ?>/colophon" class="text-small text-color-secondary">Colophon</a>
          <span>&bull;</span>
          <a href="mailto:nico@slrncl.com" class="text-small text-color-secondary">Email</a>
        </div>
